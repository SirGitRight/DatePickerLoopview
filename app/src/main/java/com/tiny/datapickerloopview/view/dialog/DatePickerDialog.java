...
public class DatePickerDialog implements View.OnClickListener {
    ...
    protected int minYear; // min year
    protected int maxYear; // max year
    ...
    protected int yearPos = 0;//从零开始
    protected int monthPos = 0;//从零开始
    protected int dayPos = 0;//从零开始
    ...
    protected int btnTextsize;//text btnTextsize of cancel and confirm button
    ...
    public static class Builder {
        ...
        public Builder minMinute(int minMinute) {
        ...
        public Builder textTitle(String textTitle) {
    ...
    protected void initView() {
        ...
        txtTitle = (TextView) contentView.findViewById(R.id.dialog_title);
    ...
    int  selenum=0;
    protected void buEnabled(boolean down) {
        if (down)
        {
            selenum--;
        }else selenum++;
        ...
        if(selenum!=0 && down)
            return;
        confirmBtn.setEnabled(down);
        if (down)
        confirmBtn.setTextColor(colorConfirm);
        else   confirmBtn.setTextColor(Color.parseColor("#EDEDED"));
    }
    ...
    private void initDayPickerView() {
        ...
        if (DatePickerMode.DAY == mode) {
            ...
            } else if (0 == yearPos && 0 == monthPos) {//第一个月，从minDay到该月最大天数
    ...
    public interface OnDatePickedListener {
        ...
        void onDateTimePickCompleted(int year, int month, int day,int  hour ,int minute
                                 );
    }
