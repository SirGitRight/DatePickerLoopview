...
import com.tiny.datapickerloopview.view.dialog.DateTimePickerDialog;
...
//                dateCurr = dateDesc;
            ...
            @Override
            public void onDateTimePickCompleted(int year, int month, int day, int hour, int minute) {
    ...
    private void showDatePickerDialogNormal() {
        int minYear = 1990;
        int maxYear = 2050;
        String dateSelect = "2017.08.25";
    //    DateTimePickerDialog pickerDialog = new DateTimePickerDialog.Builder(this, new DatePickerDialog.OnDatePickedListener() {
...
//                .build();
     //   pickerDialog.showDialog(this);
        ...
        DateTimePickerDialog pickerDialog = (DateTimePickerDialog) new DateTimePickerDialog.Builder(this, new DatePickerDialog.OnDatePickedListener() {
            ...
            public void onDateTimePickCompleted(int year, int month, int day, int hour, int minute) {
                ...
                Log.d(year+"年"+month+"月"+day+"天"+hour+"时"+minute+"分=======================================","=======================================");
